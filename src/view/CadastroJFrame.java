...
//				cmbboxSexo.showPopup();
	...
	private void randomizar() {
		txtNome.setText(rcu.randomNome());
		txtSobrenome.setText(rcu.randomSobrenome());
		txtEmail.setText(rcu.randomEmail(txtNome.getText(), txtSobrenome.getText()));
		txtRepetirEmail.setText(txtEmail.getText());
		txtSenha.setText(rcu.randomSenha());
		txtRepetirSenha.setText(txtSenha.getText());
		rcu.randomSexo(cmbboxSexo, lblSexo2);
		txtCPF.setText(rcu.randomCPF());
		txtTelefone.setText(rcu.randomTelefone());
		txtNascimento.setText(rcu.randomNascimento());
		txtCEP.setText(rcu.randomCEP());
		txtCidade.setText(rcu.randomCidade());
		txtNumero.setText(rcu.randomNumero());
	}

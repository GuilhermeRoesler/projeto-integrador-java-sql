...
CREATE TABLE `participacao` (
  ...
  CONSTRAINT `participacao_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id_cliente`),
  CONSTRAINT `participacao_ibfk_2` FOREIGN KEY (`id_evento`) REFERENCES `evento` (`id_evento`)
...
-- Dump completed on 2024-10-29  7:10:14
